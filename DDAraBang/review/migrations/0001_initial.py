# Generated by Django 2.2.9 on 2020-08-07 05:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('floor', models.CharField(choices=[('OUTSIDE', '지상'), ('SEMIINSIDE', '반지하'), ('INSIDE', '지하')], max_length=3)),
                ...
                ('recommend', models.CharField(choices=[('Yes', '네'), ('No', '아니오')], max_length=5)),
            ],
        ),
    ]
