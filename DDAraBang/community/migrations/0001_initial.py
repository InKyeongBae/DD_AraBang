<<<<<<< Updated upstream
# Generated by Django 2.1.15 on 2020-08-12 06:32
=======
# Generated by Django 2.2.15 on 2020-08-13 02:23
>>>>>>> Stashed changes
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, choices=[('한양대학교', '한양대학교'), ('경희대학교', '경희대학교'), ('중양대학교', '중양대학교'), ('연세대학교', '연세대학교')], max_length=30)),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='등록 시간')),
            ],
        ),
        migrations.AddField(
            model_name='post',
            name='School',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='community.School'),
        ),
        migrations.AddField(
            model_name='post',
            name='community',
